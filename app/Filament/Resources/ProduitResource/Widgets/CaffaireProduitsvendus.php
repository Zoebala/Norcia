...
class CaffaireProduitsvendus extends ChartWidget
{
    protected static ?string $heading = 'Cumul Chiffre d\'Affaires par Département';
    ...
    protected function getData(): array
    {
        ...
        return [
            'datasets' => [
                [
                    'label' => 'Cumul Chiffre d\'affaires par Département',
